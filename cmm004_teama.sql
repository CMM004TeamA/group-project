...
--
CREATE DATABASE IF NOT EXISTS `cmm004_teama` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `cmm004_teama`;
...
-- Database: `cmm007_db`
--
CREATE DATABASE IF NOT EXISTS `cmm007_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `cmm007_db`;
...
INSERT INTO `books` (`book_id`, `title`, `author`, `isbn`, `genre`, `quantity`, `available_quantity`, `image_path`) VALUES
(1, 'Beyond the Story', 'Myeongseok Kang', '978-1035031542', 'biography', 3, 2, 'uploads/67bdc1d8901a0-bts.jpeg');
...
(1, NULL, 1, '2025-02-26 02:35:19', NULL, NULL);
...
INSERT INTO `users` (`user_id`, `username`, `password`, `email`, `role`, `date_joined`) VALUES
(1, 'sample', '$2y$10$zaCo1vZHnemQGqHbqocCF.WPJMwpoFvpXRsTVciAIpzpIFmlW3sVS', 'sample@gmail.com', 'User', '2025-02-25'),
(2, 'jbayleaf', '$2y$10$FabKCWNn/ZXIpGy/WihFj.KgZGCkSooaZiySNWDkdNzVNIlZZQq..', 'dancingthroughlife@gmail.com', 'User', '2025-02-25'),
(3, 'bic', '$2y$10$7ZYVkRCxS3IEnrjxr9yExOQH2KhY1yduGRrIwg/P3nQoJPGO2rate', 'bic@gmail.com', 'User', '2025-02-25');
...
ALTER TABLE `loans`
  ...
  ADD KEY `fk_loans_user_id` (`user_id`),
...
--
ALTER TABLE `loans`
  ADD CONSTRAINT `fk_loans_book_id` FOREIGN KEY (`book_id`) REFERENCES `books` (`book_id`),
  ADD CONSTRAINT `fk_loans_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`);
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"cmm004_teama\",\"table\":\"conditions\"},{\"db\":\"cmm004_teama\",\"table\":\"sizecategories\"},{\"db\":\"cmm004_teama\",\"table\":\"Categories\"},{\"db\":\"cmm004_teama\",\"table\":\"Sizes\"},{\"db\":\"cmm004_teama\",\"table\":\"categories\"},{\"db\":\"cmm004_teama\",\"table\":\"sizes\"},{\"db\":\"CMM004_TeamA\",\"table\":\"Sizes\"},{\"db\":\"CMM004_TeamA\",\"table\":\"Conditions\"},{\"db\":\"CMM004_TeamA\",\"table\":\"sizes\"},{\"db\":\"CMM007_db\",\"table\":\"Loans\"}]');
...
('root', 'cmm004_teama', 'Categories', '{\"sorted_col\":\"`Categories`.`category_id` ASC\"}', '2025-03-04 00:47:01'),
('root', 'cmm004_teama', 'Sizes', '{\"sorted_col\":\"`Sizes`.`size_id` ASC\"}', '2025-03-04 01:21:10'),
('root', 'cmm004_teama', 'categories', '{\"sorted_col\":\"`categories`.`category_id` ASC\"}', '2025-03-04 00:41:33'),
('root', 'cmm004_teama', 'sizecategories', '{\"sorted_col\":\"`sizecategories`.`size_category_id` ASC\"}', '2025-03-04 02:19:54'),
('root', 'cmm004_teama', 'sizes', '{\"sorted_col\":\"`sizes`.`size_id` ASC\"}', '2025-03-03 21:16:56');
...
('root', '2025-03-04 16:51:00', '{\"Console\\/Mode\":\"collapse\"}');
